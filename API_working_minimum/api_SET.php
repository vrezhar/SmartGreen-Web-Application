<?php 
	...
	if(isset($_GET['setAccess']) && isset($_GET['greenhouse_id']) && isset($_GET['customer_id']) && isset($_GET['access_type'])){
	...
	else if(isset($_GET['setControl']) && isset($_GET['greenhouse_id']) && isset($_GET['customer_id'])){
	...
	else if(isset($_GET['setCustomer']) && isset($_GET['name']) && isset($_GET['phone_number']) && isset($_GET['email']) && isset($_GET['password'])){
	...
	else if(isset($_GET['setGreenhouse']) && isset($_GET['name']) && isset($_GET['address']) && isset($_GET['area']) && isset($_GET['date']) && isset($_GET['width']) && isset($_GET['length'])){
	...
	else if(isset($_GET['setNotification']) && isset($_GET['importance']) && isset($_GET['date']) && isset($_GET['notification']) && isset($_GET['greenhouse_id']) && isset($_GET['customer_id'])){
	...
	else if(isset($_GET['setSensorList']) && isset($_GET['sensor_id']) && isset($_GET['greenhouse_id']) && isset($_GET['sens_type']) && isset($_GET['x']) && isset($_GET['y']) && isset($_GET['install_date'])){
	...
	else if(isset($_GET['setSensorData']) && isset($_GET['sensor_id']) && isset($_GET['data']) && isset($_GET['date'])){
		$sql = "INSERT INTO `sensor_data`(`sensor_id`, `data`, `date`) VALUES ('".$_GET['sensor_id']."', '".$_GET['data']."', '".$_GET['date']."')";
		echo json_encode(dbInsert($mysqli, $sql));
	}
	else if(isset($_GET['setSettings']) && isset($_GET['greenhouse_id'])){
	...
	else if(isset($_GET['setSystemLog']) && isset($_GET['importance']) && isset($_GET['greenhouse_id']) && isset($_GET['customer_id']) && isset($_GET['log']) && isset($_GET['code'])){
